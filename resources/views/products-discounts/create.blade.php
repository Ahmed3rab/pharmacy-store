            ...
            <div class="w-1/2 border border-gray-200 rounded p-8">
                ...
                <template x-if="tab == 'product'">
                    <div class="space-y-4">
                        ...
                        <div x-data="{ open : false, selectedProducts: [] }" class="flex flex-col items-center mx-auto">
                            <div class="w-full">
                                                ...
                                                <template x-for="(selectedProduct, index) in selectedProducts">
                                                    <div
                                                        ...
                                                        <div class="text-xs font-normal leading-none max-w-full flex-initial"
                                                            x-text="JSON.parse(selectedProduct).name"></div>
                                                        <input type="hidden" name="products[]"
                                                            x-bind:value="JSON.parse(selectedProduct).uuid">
