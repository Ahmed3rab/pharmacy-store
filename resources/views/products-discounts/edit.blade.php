...
<div class="shadow bg-white p-6">
    ...
    <form action="{{ route('products-discounts.update', $discount) }}" method="POST" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
        ...
        <div x-data="{ tab: '{{ old('products', $discount->items)? 'product' : 'category' }}' }"
