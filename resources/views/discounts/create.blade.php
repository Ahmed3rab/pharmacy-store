...
<div class="flex justify-between items-baseline">
    <h1 class="text-2xl font-semibold text-gray-900">Create Product Discount</h1>
</div>
@endsection
        ...
        <div x-data="{ tab: '{{ old('products')? 'product' : 'category' }}' }"
            ...
            <div class="w-1/2 border border-gray-200 rounded p-8">
                <template x-if="tab == 'category'">
                    <div class="space-y-4">
                        <div x-data="component({{ old('categories')? \App\Models\Category::whereIn('uuid', old('categories'))->get() : '[]' }})"
                ...
                <template x-if="tab == 'product'">
                    <div class="space-y-4">
                        ...
                        <div x-data="component({{ old('products')? \App\Models\Product::whereIn('uuid', old('products'))->get() : '[]' }})"
                            class="flex flex-col items-center mx-auto">
                            <div class="w-full">
