                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border border-red-400 @enderror">
                            </div>
                            @error('name')
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <select id="category" name="category" class="form-select block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('category') border border-red-400 @enderror">
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <textarea id="description" name="description" rows="3" class="form-textarea block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('description') border border-red-400 @enderror">{{ old('description') }}</textarea>
                            </div>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="name" type="file" name="image" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('image') border border-red-400 @enderror">
                            </div>
                            @error('image')
                                <small class="text-red-600 text-sm">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm @error('price') border border-red-400 @enderror">
                                ...
                                <input type="number" step="0.25" id="price" name="price" value="{{ old('price') }}" class="flex-1 form-input block w-full min-w-0 rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                            </div>
                            @error('price')
                                <small class="text-red-600 text-sm">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm @error('quantity') border border-red-400 @enderror">
                                ...
                                <input type="number" step="1" id="quantity" name="quantity" value="{{ old('quantity') }}" class="flex-1 form-input block w-full min-w-0 rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                            </div>
                            @error('quantity')
                                <small class="text-red-600 text-sm">{{ $message }}</small>
                            @enderror
