                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="name" name="name" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" value="{{ $product->name }}">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <textarea id="description" name="description" rows="3" class="form-textarea block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">{{ $product->description }}</textarea>
                            </div>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input id="price" name="price" class="flex-1 form-input block w-full min-w-0 rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5" value="{{ $product->price }}">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input id="quantity" name="quantity" class="flex-1 form-input block w-full min-w-0 rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5" value="{{ $product->quantity }}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="my-3 flex justify-end">
        <form action="{{ route('products.delete', $product) }}" method="POST">
            ...
            <span class="inline-flex">
                <button type="submit" class="py-2 text-sm leading-5 font-medium text-gray-400 hover:text-gray-500 focus:outline-none focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out">
                  Delete This Product
                </button>
            </span>
        </form>
