                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="title" name="title" value="{{ old('title', $advertisement->title) }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('title') border border-red-400 @enderror">
                            </div>
                            @error('title')
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="url" name="url" value="{{ old('url', $advertisement->url) }}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('url') border border-red-400 @enderror">
                            </div>
                            @error('url')
                                <small class="text-red-600 text-sm">{{ $message }}</small>
                            @enderror
